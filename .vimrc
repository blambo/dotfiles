...
" set expandtab " Turning off for compatability with qwilr
...
" Turning of automatic indenting as it is annoying when dealing with varying tab/space indentation
"set ai "Auto indent
"set si "Smart indent
set wrap "Wrap lines
